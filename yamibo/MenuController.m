...
- (void)viewDidLoad {
    ...
    _iconImgs = @[[UIImage imageNamed:@"menu-forum"], [UIImage imageNamed:@"menu-forum"], [UIImage imageNamed:@"menu-msg"], [UIImage imageNamed:@"menu-nearby"], [UIImage imageNamed:@"menu-set"]];
}
