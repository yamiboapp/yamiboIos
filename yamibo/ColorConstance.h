 ...
 *  @brief  设置颜色常量
 */
#ifndef ColorConstance_h
#define ColorConstance_h

#define KCOLOR_RED_6D2C1D       [UIColor colorWithRGBHex:0x6D2C1D alpha:1]
...
#define KCOLOR_GRAY_70          [UIColor colorWithWhite: 0.70 alpha:1]
